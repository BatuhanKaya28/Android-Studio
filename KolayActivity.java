...
public class KolayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Sorular
        final String[] arrayQ = {getString(R.string.k1),
                getString(R.string.k2),
                getString(R.string.k3),
                getString(R.string.k4),
                getString(R.string.k5),
                getString(R.string.k6),
                getString(R.string.k7),
                getString(R.string.k8),
                getString(R.string.k9),
                getString(R.string.k10)};

        final Boolean[] arrayA = {true,false,true,true,false,false,true,false,false,true};
